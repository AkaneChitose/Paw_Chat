...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void signUp(){
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    Intent intent = new Intent(getApplicationContext(), SignInActivity.class);  //back to sign-in screen for login first
    ...
    private Boolean isValidSignUpDetails(){
        ...
        if (encodedImage == null) {
            ...
            showToast("Please check the email field!");
            return false;
        } else if (password.isEmpty()) {
            showToast("You must set the password");
            return false;
            ...
            result -> {
                if (result.getResultCode()==RESULT_OK){
                    if (result.getData() != null){
                        ...
                        try {
                            assert imageUri != null; //optional code must to check
